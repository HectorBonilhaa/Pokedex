  ...
  statContent.innerHTML += `
        <section class="profile ${pokemon.type}">
            <div class="basic-infos"  id="stat">
                ...
                <span class="number" id="number">#${pokemon.number
                  .toString()
                  .padStart(3, "0")}</span>
                    ...
                    <div class="content showContent" id="content1">
                        ...
                        <div class="right" id="right">
                            <ul>
                                ...
                                <li class="infos">${separateLastTwoCharacter(
                                  pokemon.height
                                )}cm</li>
                                <li class="infos">${separateLastCharacter(
                                  pokemon.weight
                                )}kg</li>
                                <li class="infos">${pokemon.habilities
                                  .map((hability) => hability)
                                  .join(",")}</li>
                                <li class="infos">${pokemon.groups
                                  .map((group) => group)
                                  .join(", ")}</li>
                    ...
                    <div class="content" id="content3">
                        <div class="moves">
                            ${pokemon.moves
                              .map(
                                (move) =>
                                  `<div class="contents"><span>${move}</span></div>`
                              )
                              .join("")} 
                        </div>
                    </div><!-- Tab content -->
...
function changeContent(index) {
  const navItems = ["about", "status", "moves"],
    contentItems = ["content1", "content2", "content3"];
  ...
  contentItems.forEach((item) => {
    document.getElementById(item).classList.remove("showContent");
  });
